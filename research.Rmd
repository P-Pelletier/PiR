...
**Pelletier, P. \& Wirtz, K. (2023)** Unpacking Scientific Creativity: A Team Composition Perspective
...
This article studies the adoption of AI and robotics in hospitals in Canadian metropolitan areas from 2000 to 2021. Using bibliometric data from OpenAlex, we study how earlier performance in AI and robotic technologies by local public research organizations and businesses is correlated with future adoption by hospitals. We proxy performance with both output and specialization indicators. On top of the availability of relevant new local knowledge, adoption in hospitals is correlated with the diffusion of national and international knowledge into the local ecosystem. We measure network eigenvector centrality in national and international co-publication networks in relevant fields to investigate the positioning of Canadian urban areas in the public and private collaborative network in AI and robotics. We show that the adoption of AI and robotics technologies in hospitals is linked to: a) the existence of a thriving local ecosystem supporting the development of the technologies, and b) the ease of access to national and international hot-spots for frontier research in AI and robotics. Finally, we identify a minimum threshold effect of competencies present in the hospital below which diffusion is rather difficult, and alternatively above which diffusion will become more likely.
